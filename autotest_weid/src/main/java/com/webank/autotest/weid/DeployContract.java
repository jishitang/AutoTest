...
public class DeployContract {
    ...
    private static void deployContract() {
        ...
        if (addrList.containsKey("AuthorityIssuerData")) {
            authorityIssuerDataAddress = addrList.get("AuthorityIssuerData");
            deployCptContracts(
        ...
        //System.out.println("weIdContractAddress|" + weIdContractAddress);
        //System.out.println("roleControllerAddress|" + roleControllerAddress);
        //System.out.println("authorityIssuerDataAddress|" + authorityIssuerDataAddress);
    }
    ...
    private static String deployCptContracts(
        ...
        try {
            ...
            //System.out.println("cptControllerAddress|" + cptControllerAddress);
    ...
    private static Map<String, String> deployIssuerContracts(String roleControllerAddress) {
        ...
        try {
            ...
            //System.out.println("authorityIssuerControllerAddress|" + authorityIssuerControllerAddress);
        } catch (Exception e) {
    ...
    private static String deployEvidenceContracts() {
        ...
        try {
            ...
            //System.out.println("evidenceFactoryAddress|" + evidenceFactoryAddress);
